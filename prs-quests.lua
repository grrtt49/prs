...
function addGaugeToQuestLabel(questNum)
  ...
  questContainerTable[questNum].progressBox =
    questContainerTable[questNum].progressBox or
    Geyser.HBox:new(
      {
  ...
  questContainerTable[questNum].progressBar =
    questContainerTable[questNum].progressBar or
    Geyser.Gauge:new(
      {
  ...
  questContainerTable[questNum].progressBar.front:setStyleSheet(
    string.format(
      [[
      background-color: %s;
  ...
  questContainerTable[questNum].progressLabel =
    questContainerTable[questNum].progressLabel or
    Geyser.Label:new(
      {
...
function getQuestString(quest)
  local questString =
    "<ansi_light_white>L" ..
    quest.level ..
      " " .. getCechoColor(quest.name) .. "<br> Given by: <ansi_light_yellow>" .. quest.giver.name .. "<ansi_white><br>"
  ...
  if (quest.location ~= nil) then
    questString =
      ...
      "<ansi_light_white>" ..
        quest.location.name ..
          "<ansi_white> at <ansi_light_magenta>" ..
            quest.location.coords.x .. "<ansi_white>, <ansi_light_magenta>" .. quest.location.coords.y .. "<ansi_white>"
  end
